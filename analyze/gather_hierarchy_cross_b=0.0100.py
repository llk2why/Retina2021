...
savedir = 'hierarchy_cross_b=0.0100'
...
dir_patterns = glob.glob('../results/hierarchy/hierachy_b=0.0100/*')
dir_patterns.sort()
...
for i,cfa in enumerate(cfa_order):
    ...
    plt.savefig(savedir+f'/b=0.0100_{cfa}_noise_tendency.png',dpi=300,bbox_inches='tight')
