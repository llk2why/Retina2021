...
dir_patterns = glob.glob('../results/hierarchy/clean_model/*')
dir_patterns.sort()
...
for i,cfa in enumerate(cfa_order):
    ...
    plt.savefig(savedir+f'/clean_{cfa}_noise_tendency.png',dpi=300,bbox_inches='tight')
